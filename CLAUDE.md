...
Headless REST API for CSI MasterFormat specification automation: round-trip DOCX (and UFGS `.SEC`) ↔ canonical CSI AST in PostgreSQL, with a git-style 3-way merge engine for owner redlines. TypeScript/Node 22, Express, Zod, pnpm.
