  ...
  reg.register(
    'apply_merge',
    {
      description:
        ...
        'discarded by omission. Accepted modified/conflict changes update paragraph text and bump ' +
        'the spec’s contentVersion. Supply expectedVersion (the contentVersion the diff was ' +
