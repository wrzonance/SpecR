...
// Broken cross-references within a project: spec_references flagged is_broken
// whose target section resolves to no in-project spec. Each carries an
// availableFrom advisory naming the source libraries that DO hold the missing
// section, in project-source priority order (design doc #94).
